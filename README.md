...
- `bin`, containing the *apk* files for the application. You will find inside a debug and a release version (both *apk* are unsigned which means Play Protect will raise a warning if you nstall it directly).
